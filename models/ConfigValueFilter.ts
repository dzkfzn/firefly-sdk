...
export function instanceOfConfigValueFilter(value: any): boolean {
    for (const key in ConfigValueFilter) {
        if (Object.prototype.hasOwnProperty.call(ConfigValueFilter, key)) {
            if (ConfigValueFilter[key as keyof typeof ConfigValueFilter] === value) {
                return true;
            }
        }
    }
...
export function ConfigValueFilterToJSONTyped(value: any, ignoreDiscriminator: boolean): ConfigValueFilter {
    return value as ConfigValueFilter;
}
