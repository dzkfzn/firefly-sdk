 ...
 */
export function instanceOfInsightTotalEntry(value: object): value is InsightTotalEntry {
    return true;
}
...
export function InsightTotalEntryToJSON(json: any): InsightTotalEntry {
    return InsightTotalEntryToJSONTyped(json, false);
}

export function InsightTotalEntryToJSONTyped(value?: InsightTotalEntry | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
