 ...
 */
export function instanceOfWebhookMessageArray(value: object): value is WebhookMessageArray {
...
export function WebhookMessageArrayToJSON(json: any): WebhookMessageArray {
    return WebhookMessageArrayToJSONTyped(json, false);
}

export function WebhookMessageArrayToJSONTyped(value?: WebhookMessageArray | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
