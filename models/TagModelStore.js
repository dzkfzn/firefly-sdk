...
exports.instanceOfTagModelStore = instanceOfTagModelStore;
...
exports.TagModelStoreToJSONTyped = TagModelStoreToJSONTyped;
/**
 * Check if a given object implements the TagModelStore interface.
 */
function instanceOfTagModelStore(value) {
...
function TagModelStoreToJSON(json) {
    return TagModelStoreToJSONTyped(json, false);
}
function TagModelStoreToJSONTyped(value, ignoreDiscriminator = false) {
    var _a;
    if (value == null) {
        return value;
    }
