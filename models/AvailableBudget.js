...
exports.instanceOfAvailableBudget = instanceOfAvailableBudget;
...
function AvailableBudgetFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'spentInBudgets': json['spent_in_budgets'] == null ? undefined : (json['spent_in_budgets'].map(BudgetSpent_1.BudgetSpentFromJSON)),
        'spentOutsideBudget': json['spent_outside_budget'] == null ? undefined : (json['spent_outside_budget'].map(BudgetSpent_1.BudgetSpentFromJSON)),
    };
}
function AvailableBudgetToJSON(json) {
    return AvailableBudgetToJSONTyped(json, false);
}
function AvailableBudgetToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
