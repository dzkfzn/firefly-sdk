...
exports.instanceOfAccountSingle = instanceOfAccountSingle;
...
function AccountSingleFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'data': (0, AccountRead_1.AccountReadFromJSON)(json['data']),
    };
}
function AccountSingleToJSON(json) {
    return AccountSingleToJSONTyped(json, false);
}
function AccountSingleToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        'data': (0, AccountRead_1.AccountReadToJSON)(value['data']),
    };
}
