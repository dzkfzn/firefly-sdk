 ...
 */
export function instanceOfWebhookArray(value: object): value is WebhookArray {
...
export function WebhookArrayToJSON(json: any): WebhookArray {
    return WebhookArrayToJSONTyped(json, false);
}

export function WebhookArrayToJSONTyped(value?: WebhookArray | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
