...
exports.instanceOfBasicSummaryEntry = instanceOfBasicSummaryEntry;
...
exports.BasicSummaryEntryToJSONTyped = BasicSummaryEntryToJSONTyped;
/**
 * Check if a given object implements the BasicSummaryEntry interface.
 */
function instanceOfBasicSummaryEntry(value) {
    return true;
}
...
function BasicSummaryEntryToJSON(json) {
    return BasicSummaryEntryToJSONTyped(json, false);
}
function BasicSummaryEntryToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
