...
export function instanceOfRuleTriggerKeyword(value: any): boolean {
    for (const key in RuleTriggerKeyword) {
        if (Object.prototype.hasOwnProperty.call(RuleTriggerKeyword, key)) {
            if (RuleTriggerKeyword[key as keyof typeof RuleTriggerKeyword] === value) {
                return true;
            }
        }
    }
...
export function RuleTriggerKeywordToJSONTyped(value: any, ignoreDiscriminator: boolean): RuleTriggerKeyword {
    return value as RuleTriggerKeyword;
}
