...
exports.instanceOfRuleGroupSingle = instanceOfRuleGroupSingle;
...
function RuleGroupSingleFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'data': (0, RuleGroupRead_1.RuleGroupReadFromJSON)(json['data']),
    };
}
function RuleGroupSingleToJSON(json) {
    return RuleGroupSingleToJSONTyped(json, false);
}
function RuleGroupSingleToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        'data': (0, RuleGroupRead_1.RuleGroupReadToJSON)(value['data']),
    };
}
