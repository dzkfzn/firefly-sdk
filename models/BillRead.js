...
exports.instanceOfBillRead = instanceOfBillRead;
...
exports.BillReadToJSONTyped = BillReadToJSONTyped;
const Bill_1 = require("./Bill");
/**
 * Check if a given object implements the BillRead interface.
 */
function instanceOfBillRead(value) {
...
function BillReadFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'type': json['type'],
        'id': json['id'],
        'attributes': (0, Bill_1.BillFromJSON)(json['attributes']),
    };
}
function BillReadToJSON(json) {
    return BillReadToJSONTyped(json, false);
}
function BillReadToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        'type': value['type'],
        'id': value['id'],
        'attributes': (0, Bill_1.BillToJSON)(value['attributes']),
    };
}
