...
exports.instanceOfAutocompletePiggyBalance = instanceOfAutocompletePiggyBalance;
...
exports.AutocompletePiggyBalanceToJSONTyped = AutocompletePiggyBalanceToJSONTyped;
/**
 * Check if a given object implements the AutocompletePiggyBalance interface.
 */
function instanceOfAutocompletePiggyBalance(value) {
...
function AutocompletePiggyBalanceToJSON(json) {
    return AutocompletePiggyBalanceToJSONTyped(json, false);
}
function AutocompletePiggyBalanceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
