...
exports.UserBlockedCodeProperty = void 0;
exports.instanceOfUserBlockedCodeProperty = instanceOfUserBlockedCodeProperty;
...
exports.UserBlockedCodePropertyToJSONTyped = UserBlockedCodePropertyToJSONTyped;
/**
...
function instanceOfUserBlockedCodeProperty(value) {
    for (const key in exports.UserBlockedCodeProperty) {
        if (Object.prototype.hasOwnProperty.call(exports.UserBlockedCodeProperty, key)) {
            if (exports.UserBlockedCodeProperty[key] === value) {
                return true;
            }
        }
    }
...
function UserBlockedCodePropertyToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
