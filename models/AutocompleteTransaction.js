...
exports.instanceOfAutocompleteTransaction = instanceOfAutocompleteTransaction;
...
exports.AutocompleteTransactionToJSONTyped = AutocompleteTransactionToJSONTyped;
/**
 * Check if a given object implements the AutocompleteTransaction interface.
 */
function instanceOfAutocompleteTransaction(value) {
...
function AutocompleteTransactionToJSON(json) {
    return AutocompleteTransactionToJSONTyped(json, false);
}
function AutocompleteTransactionToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
