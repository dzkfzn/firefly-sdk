 ...
 */
export function instanceOfTagArray(value: object): value is TagArray {
...
export function TagArrayToJSON(json: any): TagArray {
    return TagArrayToJSONTyped(json, false);
}

export function TagArrayToJSONTyped(value?: TagArray | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
