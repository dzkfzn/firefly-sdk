 ...
 */
export function instanceOfRuleRead(value: object): value is RuleRead {
...
export function RuleReadToJSON(json: any): RuleRead {
    return RuleReadToJSONTyped(json, false);
}

export function RuleReadToJSONTyped(value?: RuleRead | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
