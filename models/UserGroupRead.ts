...
import type { UserGroupReadAttributes } from './UserGroupReadAttributes';
import {
    UserGroupReadAttributesFromJSON,
    UserGroupReadAttributesFromJSONTyped,
    UserGroupReadAttributesToJSON,
    UserGroupReadAttributesToJSONTyped,
} from './UserGroupReadAttributes';
 ...
 */
export function instanceOfUserGroupRead(value: object): value is UserGroupRead {
...
export function UserGroupReadFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserGroupRead {
    ...
    return {
        ...
        'type': json['type'],
        'id': json['id'],
        'attributes': UserGroupReadAttributesFromJSON(json['attributes']),
        'links': ObjectLinkFromJSON(json['links']),
    };
}

export function UserGroupReadToJSON(json: any): UserGroupRead {
    return UserGroupReadToJSONTyped(json, false);
}

export function UserGroupReadToJSONTyped(value?: UserGroupRead | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'type': value['type'],
        'id': value['id'],
        'attributes': UserGroupReadAttributesToJSON(value['attributes']),
