...
exports.instanceOfAutocompleteTransactionID = instanceOfAutocompleteTransactionID;
...
exports.AutocompleteTransactionIDToJSONTyped = AutocompleteTransactionIDToJSONTyped;
/**
 * Check if a given object implements the AutocompleteTransactionID interface.
 */
function instanceOfAutocompleteTransactionID(value) {
...
function AutocompleteTransactionIDToJSON(json) {
    return AutocompleteTransactionIDToJSONTyped(json, false);
}
function AutocompleteTransactionIDToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
