 ...
 */
export function instanceOfRecurrenceRepetitionUpdate(value: object): value is RecurrenceRepetitionUpdate {
    return true;
}
...
export function RecurrenceRepetitionUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecurrenceRepetitionUpdate {
    ...
    return {
        ...
        'type': json['type'] == null ? undefined : RecurrenceRepetitionTypeFromJSON(json['type']),
...
export function RecurrenceRepetitionUpdateToJSON(json: any): RecurrenceRepetitionUpdate {
    return RecurrenceRepetitionUpdateToJSONTyped(json, false);
}

export function RecurrenceRepetitionUpdateToJSONTyped(value?: RecurrenceRepetitionUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
