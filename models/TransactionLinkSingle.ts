 ...
 */
export function instanceOfTransactionLinkSingle(value: object): value is TransactionLinkSingle {
...
export function TransactionLinkSingleToJSON(json: any): TransactionLinkSingle {
    return TransactionLinkSingleToJSONTyped(json, false);
}

export function TransactionLinkSingleToJSONTyped(value?: TransactionLinkSingle | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
