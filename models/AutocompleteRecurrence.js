...
exports.instanceOfAutocompleteRecurrence = instanceOfAutocompleteRecurrence;
...
exports.AutocompleteRecurrenceToJSONTyped = AutocompleteRecurrenceToJSONTyped;
/**
 * Check if a given object implements the AutocompleteRecurrence interface.
 */
function instanceOfAutocompleteRecurrence(value) {
...
function AutocompleteRecurrenceToJSON(json) {
    return AutocompleteRecurrenceToJSONTyped(json, false);
}
function AutocompleteRecurrenceToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
