...
exports.instanceOfWebhookArray = instanceOfWebhookArray;
...
exports.WebhookArrayToJSONTyped = WebhookArrayToJSONTyped;
const Meta_1 = require("./Meta");
const PageLink_1 = require("./PageLink");
const WebhookRead_1 = require("./WebhookRead");
/**
 * Check if a given object implements the WebhookArray interface.
 */
function instanceOfWebhookArray(value) {
...
function WebhookArrayFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'data': (json['data'].map(WebhookRead_1.WebhookReadFromJSON)),
        'meta': (0, Meta_1.MetaFromJSON)(json['meta']),
        'links': (0, PageLink_1.PageLinkFromJSON)(json['links']),
    };
}
function WebhookArrayToJSON(json) {
    return WebhookArrayToJSONTyped(json, false);
}
function WebhookArrayToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        'data': (value['data'].map(WebhookRead_1.WebhookReadToJSON)),
