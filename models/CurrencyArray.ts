 ...
 */
export function instanceOfCurrencyArray(value: object): value is CurrencyArray {
...
export function CurrencyArrayToJSON(json: any): CurrencyArray {
    return CurrencyArrayToJSONTyped(json, false);
}

export function CurrencyArrayToJSONTyped(value?: CurrencyArray | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
