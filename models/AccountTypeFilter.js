...
exports.AccountTypeFilter = void 0;
exports.instanceOfAccountTypeFilter = instanceOfAccountTypeFilter;
...
exports.AccountTypeFilterToJSONTyped = AccountTypeFilterToJSONTyped;
/**
 *
 * @export
 */
...
function instanceOfAccountTypeFilter(value) {
    for (const key in exports.AccountTypeFilter) {
        if (Object.prototype.hasOwnProperty.call(exports.AccountTypeFilter, key)) {
            if (exports.AccountTypeFilter[key] === value) {
                return true;
            }
        }
    }
...
function AccountTypeFilterToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
