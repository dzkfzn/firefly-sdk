 ...
 */
export function instanceOfRuleGroupSingle(value: object): value is RuleGroupSingle {
...
export function RuleGroupSingleToJSON(json: any): RuleGroupSingle {
    return RuleGroupSingleToJSONTyped(json, false);
}

export function RuleGroupSingleToJSONTyped(value?: RuleGroupSingle | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
