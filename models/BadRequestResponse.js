...
exports.instanceOfBadRequestResponse = instanceOfBadRequestResponse;
...
exports.BadRequestResponseToJSONTyped = BadRequestResponseToJSONTyped;
/**
 * Check if a given object implements the BadRequestResponse interface.
 */
function instanceOfBadRequestResponse(value) {
    return true;
}
...
function BadRequestResponseToJSON(json) {
    return BadRequestResponseToJSONTyped(json, false);
}
function BadRequestResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
