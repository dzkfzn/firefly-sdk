 ...
 */
export function instanceOfTransactionSplitStore(value: object): value is TransactionSplitStore {
...
export function TransactionSplitStoreToJSON(json: any): TransactionSplitStore {
    return TransactionSplitStoreToJSONTyped(json, false);
}

export function TransactionSplitStoreToJSONTyped(value?: TransactionSplitStore | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
