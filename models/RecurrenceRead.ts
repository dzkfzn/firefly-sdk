 ...
 */
export function instanceOfRecurrenceRead(value: object): value is RecurrenceRead {
...
export function RecurrenceReadToJSON(json: any): RecurrenceRead {
    return RecurrenceReadToJSONTyped(json, false);
}

export function RecurrenceReadToJSONTyped(value?: RecurrenceRead | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
