...
export class DataApi extends runtime.BaseAPI {
    ...
    async bulkUpdateTransactionsRaw(requestParameters: BulkUpdateTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['query'] == null) {
            throw new runtime.RequiredError(
                'query',
                'Required parameter "query" was null or undefined when calling bulkUpdateTransactions().'
            );
        }
    ...
    async destroyDataRaw(requestParameters: DestroyDataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['objects'] == null) {
            throw new runtime.RequiredError(
                'objects',
                'Required parameter "objects" was null or undefined when calling destroyData().'
            );
        }
    ...
    async exportTransactionsRaw(requestParameters: ExportTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['start'] == null) {
            throw new runtime.RequiredError(
                'start',
                'Required parameter "start" was null or undefined when calling exportTransactions().'
            );
        }
        ...
        if (requestParameters['end'] == null) {
            throw new runtime.RequiredError(
                'end',
                'Required parameter "end" was null or undefined when calling exportTransactions().'
            );
        }
