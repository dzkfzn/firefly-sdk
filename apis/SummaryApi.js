...
class SummaryApi extends runtime.BaseAPI {
     ...
     */
    getBasicSummaryRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters['start'] == null) {
                throw new runtime.RequiredError('start', 'Required parameter "start" was null or undefined when calling getBasicSummary().');
            }
            if (requestParameters['end'] == null) {
                throw new runtime.RequiredError('end', 'Required parameter "end" was null or undefined when calling getBasicSummary().');
            }
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => runtime.mapValues(jsonValue, index_1.BasicSummaryEntryFromJSON));
        });
    }
    /**
     * Returns basic sums of the users data, like the net worth, spent and earned amounts. It is multi-currency, and is used in Firefly III to populate the dashboard.
     * Returns basic sums of the users data.
     */
    getBasicSummary(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getBasicSummaryRaw(requestParameters, initOverrides);
