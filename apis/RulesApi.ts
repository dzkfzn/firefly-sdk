...
export class RulesApi extends runtime.BaseAPI {
    ...
    async fireRuleRaw(requestParameters: FireRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling fireRule().'
            );
        }
    ...
    async storeRuleRaw(requestParameters: StoreRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RuleSingle>> {
        if (requestParameters['ruleStore'] == null) {
            throw new runtime.RequiredError(
                'ruleStore',
                'Required parameter "ruleStore" was null or undefined when calling storeRule().'
            );
        }
    ...
    async testRuleRaw(requestParameters: TestRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TransactionArray>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling testRule().'
            );
        }
    ...
    async updateRuleRaw(requestParameters: UpdateRuleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RuleSingle>> {
        ...
        if (requestParameters['ruleUpdate'] == null) {
            throw new runtime.RequiredError(
                'ruleUpdate',
                'Required parameter "ruleUpdate" was null or undefined when calling updateRule().'
            );
        }
